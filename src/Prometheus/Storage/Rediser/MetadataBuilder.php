...
class MetadataBuilder
{
	...
	/**
	 * @param string|null $labelValues
	 * @return MetadataBuilder
     * @see Rediser::serializeMetadata() for the inverse operation on this data.
	 */
	public function withLabelValues(?string $labelValues): MetadataBuilder
	{
